...
```
### Item usage and wearable restrictions from traits
...
```
{
  ...
  "ExclusiveWearables": ["game:armor-body-antique-forlorn-*"], // Makes forlorn hope armor exclusive to owners of this trait only
  "AllowedFood": {
